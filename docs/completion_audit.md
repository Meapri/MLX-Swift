...
| Video-capable model generation works end-to-end | `MLXVLM_REAL_QWEN25VL_MODEL=/Users/naen/Models/mlx-community-Qwen2.5-VL-3B-Instruct-3bit SWIFT_BUILD_JOBS=18 scripts/verify_real_qwen25vl_video_smoke.sh` passed after downloading `mlx-community/Qwen2.5-VL-3B-Instruct-3bit` locally; the gate now covers upstream tokenizer, OpenAI image data URI, OpenAI video file URL, and OpenAI SSE streaming | Done for Qwen2.5-VL 3B 3bit |
